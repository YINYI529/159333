...
plt.plot(res.index,res['greedy'],label='greedy',linewidth = 2)
plt.plot(res.index,res['backtracking'],'g--',label='backtracking',linewidth = 2)
plt.plot(res.index,res['smallest last'],'r-.',label='smallest last',linewidth = 2)
plt.ylabel('cost time (s)')
plt.xlabel('Export the cumulative number of students')
plt.title('Comparison of three graph coloring algorithms')
plt.legend()
plt.show();
